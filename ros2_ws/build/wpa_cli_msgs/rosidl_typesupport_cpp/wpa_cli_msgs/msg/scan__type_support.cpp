...
static const _Scan_type_support_symbol_names_t _Scan_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wpa_cli_msgs, msg, Scan)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, wpa_cli_msgs, msg, Scan)),
  }
};
...
{
  return &::wpa_cli_msgs::msg::rosidl_typesupport_cpp::Scan_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, wpa_cli_msgs, msg, Scan)() {
  return get_message_type_support_handle<wpa_cli_msgs::msg::Scan>();
}
