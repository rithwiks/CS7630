...
#include "wpa_cli_msgs/msg/detail/scan__rosidl_typesupport_fastrtps_c.h"
...
#include "wpa_cli_msgs/msg/detail/network__functions.h"  // networks

// forward declare type support functions
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_wpa_cli_msgs
...
using _Scan__ros_msg_type = wpa_cli_msgs__msg__Scan;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: networks
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, wpa_cli_msgs, msg, Network
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: networks
  {
    ...
    if (ros_message->networks.data) {
      wpa_cli_msgs__msg__Network__Sequence__fini(&ros_message->networks);
    }
...
size_t get_serialized_size_wpa_cli_msgs__msg__Scan(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Scan__ros_msg_type * ros_message = static_cast<const _Scan__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name networks
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_wpa_cli_msgs__msg__Network(
...
static uint32_t _Scan__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_wpa_cli_msgs__msg__Scan(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_wpa_cli_msgs
size_t max_serialized_size_wpa_cli_msgs__msg__Scan(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: networks
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_wpa_cli_msgs__msg__Network(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = wpa_cli_msgs__msg__Scan;
    is_plain =
      (
...
static size_t _Scan__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_wpa_cli_msgs__msg__Scan(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, wpa_cli_msgs, msg, Scan)() {
