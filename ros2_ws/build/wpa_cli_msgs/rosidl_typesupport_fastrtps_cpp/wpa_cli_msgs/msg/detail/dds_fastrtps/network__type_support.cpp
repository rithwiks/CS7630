...
#include "wpa_cli_msgs/msg/detail/network__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const wpa_cli_msgs::msg::Network & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  wpa_cli_msgs::msg::Network & ros_message)
{
  // Member: bssid
  cdr >> ros_message.bssid;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = wpa_cli_msgs::msg::Network;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const wpa_cli_msgs::msg::Network *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<wpa_cli_msgs::msg::Network *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Network__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const wpa_cli_msgs::msg::Network *>(
...
static size_t _Network__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Network(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Network__callbacks = {
  "wpa_cli_msgs::msg",
  "Network",
...
static rosidl_message_type_support_t _Network__handle = {
...
{
  return &wpa_cli_msgs::msg::typesupport_fastrtps_cpp::_Network__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wpa_cli_msgs, msg, Network)() {
  return &wpa_cli_msgs::msg::typesupport_fastrtps_cpp::_Network__handle;
}
