...
#include "task_manager_msgs/msg/detail/task_description__rosidl_typesupport_fastrtps_c.h"
...
#include "rcl_interfaces/msg/detail/parameter_descriptor__functions.h"  // config
...
using _TaskDescription__ros_msg_type = task_manager_msgs__msg__TaskDescription;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: config
  {
    ...
    if (ros_message->config.data) {
      rcl_interfaces__msg__ParameterDescriptor__Sequence__fini(&ros_message->config);
    }
...
static uint32_t _TaskDescription__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_task_manager_msgs__msg__TaskDescription(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = task_manager_msgs__msg__TaskDescription;
    is_plain =
      (
...
static size_t _TaskDescription__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_task_manager_msgs__msg__TaskDescription(
