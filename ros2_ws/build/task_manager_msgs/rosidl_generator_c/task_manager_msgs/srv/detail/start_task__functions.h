...
#ifndef TASK_MANAGER_MSGS__SRV__DETAIL__START_TASK__FUNCTIONS_H_
#define TASK_MANAGER_MSGS__SRV__DETAIL__START_TASK__FUNCTIONS_H_
 ...
 * calls
 * task_manager_msgs__srv__StartTask_Request__init().
...
/**
 * It calls
 * task_manager_msgs__srv__StartTask_Request__fini()
 ...
 * task_manager_msgs__srv__StartTask_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * task_manager_msgs__srv__StartTask_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * task_manager_msgs__srv__StartTask_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_task_manager_msgs
...
/**
 * It calls
 * task_manager_msgs__srv__StartTask_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_task_manager_msgs
...
/**
 * It allocates the memory for the array and calls
 * task_manager_msgs__srv__StartTask_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_task_manager_msgs
...
/**
 * It calls
 * task_manager_msgs__srv__StartTask_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TASK_MANAGER_MSGS__SRV__DETAIL__START_TASK__FUNCTIONS_H_
