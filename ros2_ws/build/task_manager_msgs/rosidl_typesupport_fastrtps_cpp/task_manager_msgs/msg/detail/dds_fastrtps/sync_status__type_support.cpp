...
#include "task_manager_msgs/msg/detail/sync_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const task_manager_msgs::msg::SyncStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  task_manager_msgs::msg::SyncStatus & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = task_manager_msgs::msg::SyncStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const task_manager_msgs::msg::SyncStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<task_manager_msgs::msg::SyncStatus *>(
    untyped_ros_message);
...
{
  return &task_manager_msgs::msg::typesupport_fastrtps_cpp::_SyncStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, task_manager_msgs, msg, SyncStatus)() {
  return &task_manager_msgs::msg::typesupport_fastrtps_cpp::_SyncStatus__handle;
}
