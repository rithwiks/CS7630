...
#include "cs7630_msgs/msg/detail/region_of_interest_array__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cs7630_msgs::msg::RegionOfInterestArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cs7630_msgs::msg::RegionOfInterestArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cs7630_msgs::msg::RegionOfInterestArray *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RegionOfInterestArray__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const cs7630_msgs::msg::RegionOfInterestArray *>(
...
static size_t _RegionOfInterestArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RegionOfInterestArray(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RegionOfInterestArray__callbacks = {
  "cs7630_msgs::msg",
...
static rosidl_message_type_support_t _RegionOfInterestArray__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RegionOfInterestArray__callbacks,
...
{
  return &cs7630_msgs::msg::typesupport_fastrtps_cpp::_RegionOfInterestArray__handle;
}
