...
#ifndef TASK_MANAGER_MSGS__SRV__DETAIL__STOP_TASK__FUNCTIONS_H_
#define TASK_MANAGER_MSGS__SRV__DETAIL__STOP_TASK__FUNCTIONS_H_
...
/// Initialize srv/StopTask message.
/**
...
/// Create srv/StopTask message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * task_manager_msgs__srv__StopTask_Request__init().
...
/// Destroy srv/StopTask message.
/**
 * It calls
 * task_manager_msgs__srv__StopTask_Request__fini()
...
/// Check for srv/StopTask message equality.
/**
...
/// Initialize array of srv/StopTask messages.
/**
...
/// Finalize array of srv/StopTask messages.
/**
 * It calls
 * task_manager_msgs__srv__StopTask_Request__fini()
...
/// Create array of srv/StopTask messages.
/**
 * It allocates the memory for the array and calls
 * task_manager_msgs__srv__StopTask_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/StopTask messages.
/**
 * It calls
 * task_manager_msgs__srv__StopTask_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/StopTask message array equality.
/**
...
/// Copy an array of srv/StopTask messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * task_manager_msgs__srv__StopTask_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_task_manager_msgs
...
/**
 * It calls
 * task_manager_msgs__srv__StopTask_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_task_manager_msgs
...
/**
 * It allocates the memory for the array and calls
 * task_manager_msgs__srv__StopTask_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_task_manager_msgs
...
/**
 * It calls
 * task_manager_msgs__srv__StopTask_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TASK_MANAGER_MSGS__SRV__DETAIL__STOP_TASK__FUNCTIONS_H_
