...
#include "task_manager_msgs/srv/detail/get_task_list__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = task_manager_msgs::srv::GetTaskList_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const task_manager_msgs::srv::GetTaskList_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<task_manager_msgs::srv::GetTaskList_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetTaskList_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const task_manager_msgs::srv::GetTaskList_Request *>(
...
static size_t _GetTaskList_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetTaskList_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetTaskList_Request__callbacks = {
...
static rosidl_message_type_support_t _GetTaskList_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetTaskList_Request__callbacks,
...
{
  return &task_manager_msgs::srv::typesupport_fastrtps_cpp::_GetTaskList_Request__handle;
}
...
{
bool cdr_serialize(
  const task_manager_msgs::msg::TaskDescription &,
  ...
  // Member: tlist
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.tlist[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: tlist
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        task_manager_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_TaskDescription(
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = task_manager_msgs::srv::GetTaskList_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const task_manager_msgs::srv::GetTaskList_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<task_manager_msgs::srv::GetTaskList_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetTaskList_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const task_manager_msgs::srv::GetTaskList_Response *>(
...
static size_t _GetTaskList_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetTaskList_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetTaskList_Response__callbacks = {
  "task_manager_msgs::srv",
...
static rosidl_message_type_support_t _GetTaskList_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetTaskList_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &task_manager_msgs::srv::typesupport_fastrtps_cpp::_GetTaskList_Response__handle;
}
...
static service_type_support_callbacks_t _GetTaskList__callbacks = {
  "task_manager_msgs::srv",
  "GetTaskList",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, task_manager_msgs, srv, GetTaskList_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, task_manager_msgs, srv, GetTaskList_Response)(),
...
static rosidl_service_type_support_t _GetTaskList__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetTaskList__callbacks,
...
{
  return &task_manager_msgs::srv::typesupport_fastrtps_cpp::_GetTaskList__handle;
}
