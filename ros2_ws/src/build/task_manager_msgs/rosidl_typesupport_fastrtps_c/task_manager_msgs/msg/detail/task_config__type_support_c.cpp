...
#include "task_manager_msgs/msg/detail/task_config__rosidl_typesupport_fastrtps_c.h"
...
using _TaskConfig__ros_msg_type = task_manager_msgs__msg__TaskConfig;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _TaskConfig__ros_msg_type * ros_message = static_cast<const _TaskConfig__ros_msg_type *>(untyped_ros_message);
  // Field name: plist
  {
  ...
  void * untyped_ros_message)
{
  ...
  _TaskConfig__ros_msg_type * ros_message = static_cast<_TaskConfig__ros_msg_type *>(untyped_ros_message);
  // Field name: plist
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_task_manager_msgs__msg__TaskConfig(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TaskConfig__ros_msg_type * ros_message = static_cast<const _TaskConfig__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _TaskConfig__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_task_manager_msgs__msg__TaskConfig(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_task_manager_msgs
size_t max_serialized_size_task_manager_msgs__msg__TaskConfig(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = task_manager_msgs__msg__TaskConfig;
    is_plain =
      (
...
static size_t _TaskConfig__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_task_manager_msgs__msg__TaskConfig(
...
static message_type_support_callbacks_t __callbacks_TaskConfig = {
...
static rosidl_message_type_support_t _TaskConfig__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_TaskConfig,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, task_manager_msgs, msg, TaskConfig)() {
  return &_TaskConfig__type_support;
}
