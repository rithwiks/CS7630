...
{
  new (message_memory) task_manager_msgs::msg::SyncStatus(_init);
}

void SyncStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<task_manager_msgs::msg::SyncStatus *>(message_memory);
  typed_message->~SyncStatus();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember SyncStatus_message_member_array[2] = {
  {
    "header",  // name
    ...
    offsetof(task_manager_msgs::msg::SyncStatus, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(task_manager_msgs::msg::SyncStatus, status),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SyncStatus_message_members = {
  ...
  2,  // number of fields
  sizeof(task_manager_msgs::msg::SyncStatus),
...
{
  return &::task_manager_msgs::msg::rosidl_typesupport_introspection_cpp::SyncStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, task_manager_msgs, msg, SyncStatus)() {
  return &::task_manager_msgs::msg::rosidl_typesupport_introspection_cpp::SyncStatus_message_type_support_handle;
}
